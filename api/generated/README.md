...
*AuthControllerApi* | [**authSMS**](doc//AuthControllerApi.md#authsms) | **POST** /auth/sms | 전화번호 인증
*AuthControllerApi* | [**checkAuthSMS**](doc//AuthControllerApi.md#checkauthsms) | **POST** /auth/sms/check | 전화번호 인증확인
...
*UserAPIApi* | [**updateCoverImage**](doc//UserAPIApi.md#updatecoverimage) | **PATCH** /user/update-cover-image | 유저 배경사진 업데이트
