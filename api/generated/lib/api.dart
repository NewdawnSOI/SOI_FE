...
part 'api/notification_device_api_api.dart';
part 'api/post_api_api.dart';
part 'api/report_controller_api.dart';
...
part 'model/api_response_dto_list_report_response_dto.dart';
...
part 'model/api_response_dto_report_response_dto.dart';
part 'model/api_response_dto_slice_comment_resp_dto.dart';
part 'model/api_response_dto_slice_post_resp_dto.dart';
...
part 'model/login_req_dto.dart';
part 'model/login_resp_dto.dart';
part 'model/notification_delete_token_req_dto.dart';
part 'model/notification_get_all_resp_dto.dart';
part 'model/notification_register_token_req_dto.dart';
...
part 'model/report_update_req_dto.dart';
part 'model/slice_comment_resp_dto.dart';
part 'model/slice_post_resp_dto.dart';
part 'model/sort_object.dart';
part 'model/sort_option_dto.dart';
