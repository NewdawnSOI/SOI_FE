...
class CommentRespDto {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.replyCommentCount != null) {
      json[r'replyCommentCount'] = this.replyCommentCount;
    } else {
      json[r'replyCommentCount'] = null;
    }
    return json;
  }
  ...
  static CommentRespDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommentRespDto(
        ...
        replyCommentCount: mapValueOfType<int>(json, r'replyCommentCount'),
      );
    }
    return null;
  }
