...
class NotificationRespDtoTypeEnum {
  ...
  static const COMMENT_VIDEO_ADDED = NotificationRespDtoTypeEnum._(r'COMMENT_VIDEO_ADDED');
  static const COMMENT_PHOTO_ADDED = NotificationRespDtoTypeEnum._(r'COMMENT_PHOTO_ADDED');
  ...
  NotificationRespDtoTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'COMMENT_VIDEO_ADDED': return NotificationRespDtoTypeEnum.COMMENT_VIDEO_ADDED;
        case r'COMMENT_PHOTO_ADDED': return NotificationRespDtoTypeEnum.COMMENT_PHOTO_ADDED;
