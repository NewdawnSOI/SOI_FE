...
import '../../../../features/tagging/domain/tagging_state_models.dart';
import '../comment_tag_specs.dart';

/// pending 상태의 프로필 태그의 크기를 정의하는 변수
const double kPendingCommentTagSize = CommentProfileTagSpec.frameSize;

/// pending 상태 댓글 태그의 회색 배경과 내부 프로필 이미지 사이의 간격을 정의하는 변수
const double kPendingCommentTagPadding = CommentProfileTagSpec.padding;
...
const double kPendingCommentAvatarSize = CommentProfileTagSpec.avatarSize;

/// API 버전 pending 댓글 UI 마커 정보입니다.
/// - 음성 댓글 녹음 중이거나 텍스트 댓글 입력 중인 상태에서 댓글이 작성될 위치를 보관합니다.
typedef PendingApiCommentMarker = TaggingPendingMarker;
...
typedef PendingApiCommentDraft = TaggingPendingDraft;
